#!/usr/bin/env python3
"""Lock a post-r104 v1.5 reactivated-dual unique-finishable-power no-risky-nonpositive-pressure-margin-cap training protocol."""
...
DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r105_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r105_reactivated_dual_unique_finishable_power_no_risky_nonpositive_pressure_margin_cap"
REQUIREMENTS_COVERED = ["V15-R105-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261577 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r105 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R105_REACTIVATED_DUAL_UNIQUE_FINISHABLE_POWER_NO_RISKY_NONPOSITIVE_PRESSURE_MARGIN_CAP_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "route-horizon movement-level time normalization stays active only on risky movements inside weak completion phases",
                "completion-filter thin wins are capped only when no risky movement was normalized, the phase has no positive local-pressure support, and a core baseline still has a clearly stronger raw horizon score",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r104_reactivated_dual_unique_finishable_power_no_risky_margin_cap",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r104_training_selection.json",
    }
    return {
        "experiment": "v1_5_r105_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r105_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r105_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r105_training_selection.json",
        },

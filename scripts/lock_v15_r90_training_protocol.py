#!/usr/bin/env python3
"""Lock a post-r79 v1.5 reactivated-dual supported thin-margin-cap training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R90_REACTIVATED_DUAL_SUPPORTED_MARGIN_CAP_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r90_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r90_reactivated_dual_supported_margin_cap"
REQUIREMENTS_COVERED = ["V15-R90-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261487 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r90 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R90_REACTIVATED_DUAL_SUPPORTED_MARGIN_CAP_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "only thin-margin early-severe low-signal completion outranks are capped",
                "thin-margin caps only engage when the best core baseline still has real route-horizon support",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r89_reactivated_dual_low_signal_margin_cap",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r89_training_selection.json",
    }
    return {
        "experiment": "v1_5_r90_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r90_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r90_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r90_training_selection.json",
        },

#!/usr/bin/env python3
"""Lock a post-r96 v1.5 reactivated-dual unique-finishable-ratio-horizon training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R99_REACTIVATED_DUAL_UNIQUE_FINISHABLE_RATIO_HORIZON_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r99_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r99_reactivated_dual_unique_finishable_ratio_horizon"
REQUIREMENTS_COVERED = ["V15-R99-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261541 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r99 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R99_REACTIVATED_DUAL_UNIQUE_FINISHABLE_RATIO_HORIZON_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "route-horizon completion credit is normalized by total movement demand instead of raw volume",
    ...
    return {
        "experiment": "v1_5_r99_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r99_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r99_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r99_training_selection.json",
        },

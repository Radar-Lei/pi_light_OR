#!/usr/bin/env python3
"""Lock a post-r10 v1.5-r11 completion-risk training protocol with fresh seeds."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R11_COMPLETION_RISK_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r11_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r11_completion_risk"
REQUIREMENTS_COVERED = ["V15-R11-CTRL-01", "V15-CLAIM-01"]
TRAINING_SCENARIOS = ["arterial_v1_5_storage_activation", "arterial_spillback_stress", "arterial_downstream_blockage"]
TRAINING_SEEDS = [20260891 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r11 training seeds overlap excluded seeds: {overlap}")
    ...
    core = {
        ...
        "controller_params": DYNAMIC_V1_5_R11_COMPLETION_RISK_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "completion-risk filter preserves service capacity under high backlog, high occupancy, or late-horizon risk",
            ],
            "not_confirmatory_evidence": True,
        },
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r10_bounded_hold",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_revision_candidate_summary.json",
    }
    return {
        "experiment": "v1_5_r11_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r11_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r11_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r11_training_selection.json",
        },

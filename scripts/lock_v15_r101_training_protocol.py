#!/usr/bin/env python3
"""Lock a post-r98 v1.5 reactivated-dual unique-finishable-power conditional-time-weight-horizon training protocol."""
...
DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r101_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r101_reactivated_dual_unique_finishable_power_conditional_time_weight_horizon"
REQUIREMENTS_COVERED = ["V15-R101-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261553 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r101 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R101_REACTIVATED_DUAL_UNIQUE_FINISHABLE_POWER_CONDITIONAL_TIME_WEIGHT_HORIZON_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "route-horizon time normalization sharpens only for no-positive-local-pressure low-residual completion phases",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r100_reactivated_dual_unique_finishable_power_time_weight_horizon",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r100_training_selection.json",
    }
    return {
        "experiment": "v1_5_r101_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r101_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r101_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r101_training_selection.json",
        },

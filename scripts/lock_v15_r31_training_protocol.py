#!/usr/bin/env python3
"""Lock a post-r30 v1.5 late-double-terminal training protocol."""
...
from lock_v15_r26_training_protocol import TRAINING_SEEDS as R26_TRAINING_SEEDS
from lock_v15_r27_training_protocol import TRAINING_SEEDS as R27_TRAINING_SEEDS
from lock_v15_r28_training_protocol import TRAINING_SEEDS as R28_TRAINING_SEEDS
from lock_v15_r29_training_protocol import TRAINING_SEEDS as R29_TRAINING_SEEDS
from lock_v15_r30_training_protocol import TRAINING_SEEDS as R30_TRAINING_SEEDS
from run_closed_loop_sumo import DYNAMIC_V1_5_R31_LATE_DOUBLE_TERMINAL_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r31_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r31_late_double_terminal"
REQUIREMENTS_COVERED = ["V15-R31-CTRL-01", "V15-CLAIM-01"]
TRAINING_SCENARIOS = ["arterial_v1_5_storage_activation", "arterial_spillback_stress", "arterial_downstream_blockage"]
TRAINING_SEEDS = [20261091 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    excluded = (
        ...
        | set(R26_TRAINING_SEEDS)
        | set(R27_TRAINING_SEEDS)
        | set(R28_TRAINING_SEEDS)
        | set(R29_TRAINING_SEEDS)
        | set(R30_TRAINING_SEEDS)
    )
    overlap = sorted(set(TRAINING_SEEDS) & excluded)
    if overlap:
        raise ValueError(f"r31 training seeds overlap excluded seeds: {overlap}")
    ...
    core = {
        ...
        "controller_params": DYNAMIC_V1_5_R31_LATE_DOUBLE_TERMINAL_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "late finite-storage-double terminal lock tests whether r24's earlier terminal lock caused unfinished safety harm",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r30_double_envelope",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r30_training_selection.json",
    }
    return {
        "experiment": "v1_5_r31_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r31_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r31_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r31_training_selection.json",
        },

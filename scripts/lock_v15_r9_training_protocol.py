#!/usr/bin/env python3
"""Lock a post-r8 v1.5-r9 hold-only training protocol with fresh seeds."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R9_HOLD_ONLY_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r9_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r9_hold_only"
REQUIREMENTS_COVERED = ["V15-R9-TRAIN-01", "V15-CLAIM-01"]
TRAINING_SCENARIOS = [
    "arterial_v1_5_storage_activation",
    "arterial_spillback_stress",
    "arterial_downstream_blockage",
]
TRAINING_SEEDS = [20260871 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r9 training seeds overlap excluded seeds: {overlap}")
    ...
    training_split = {
        ...
        "excluded_seed_sets": {
            ...
            "v1_5_r5_training_protocol": list(R5_TRAINING_SEEDS),
            "v1_5_r6_training_protocol": list(R6_TRAINING_SEEDS),
            "v1_5_r7_training_protocol": list(R7_TRAINING_SEEDS),
            "v1_5_r8_training_protocol": list(R8_TRAINING_SEEDS),
        },
    ...
    core = {
        ...
        "controller_params": DYNAMIC_V1_5_R9_HOLD_ONLY_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "dynamic overrides may only hold the current phase instead of introducing new switches",
                "action separation from pressure remains nonzero on binding training rows",
            ],
            "not_confirmatory_evidence": True,
        },
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r8_multi_baseline_filter",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r8_training_selection.json",
    }
    payload: dict[str, Any] = {
        "experiment": "v1_5_r9_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r9_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r9_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r9_training_selection.json",
            "future_confirmatory_protocol": "experiments/dual_sensitivity/v1_5_r9_locked_protocol.json",
        },
        "claim_scope": {
            "claim_ready": False,

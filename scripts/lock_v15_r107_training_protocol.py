#!/usr/bin/env python3
"""Lock a post-r103 v1.5 reactivated-dual low-support-bonus-damping training protocol."""
...
DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r107_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r107_reactivated_dual_low_support_bonus_damping"
REQUIREMENTS_COVERED = ["V15-R107-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261589 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r107 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R107_REACTIVATED_DUAL_LOW_SUPPORT_BONUS_DAMPING_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "route-horizon blend directly damps release/storage-risk bonuses on no-risky no-positive-pressure thin wins only when a core baseline still has materially stronger raw horizon support",
    ...
    return {
        "experiment": "v1_5_r107_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r107_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r107_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r107_training_selection.json",
        },

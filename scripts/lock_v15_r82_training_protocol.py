#!/usr/bin/env python3
"""Lock a post-r79 v1.5 reactivated-dual conditional low-total pressure-blend training protocol."""
...
from lock_v15_r81_training_protocol import TRAINING_SEEDS as R81_TRAINING_SEEDS
from lock_v15_r63_training_protocol import build_training_protocol as build_r63_training_protocol
from run_closed_loop_sumo import DYNAMIC_V1_5_R82_REACTIVATED_DUAL_CONDITIONAL_LOW_TOTAL_PRESSURE_BLEND_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r82_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r82_reactivated_dual_conditional_low_total_pressure_blend"
REQUIREMENTS_COVERED = ["V15-R82-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261439 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    excluded = (
        ...
        | set(R81_TRAINING_SEEDS)
    )
    overlap = sorted(set(TRAINING_SEEDS) & excluded)
    if overlap:
        raise ValueError(f"r82 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R82_REACTIVATED_DUAL_CONDITIONAL_LOW_TOTAL_PRESSURE_BLEND_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "low-total nonpositive-pressure penalty remains limited to early severe completion-filter sorting",
    ...
    return {
        "experiment": "v1_5_r82_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r82_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r82_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r82_training_selection.json",
        },

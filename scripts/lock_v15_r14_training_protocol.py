#!/usr/bin/env python3
"""Lock a post-r13 v1.5-r14 route-demand/double-safe training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R14_ROUTE_DEMAND_DOUBLE_SAFE_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r14_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r14_route_demand_double_safe"
REQUIREMENTS_COVERED = ["V15-R14-CTRL-01", "V15-CLAIM-01"]
TRAINING_SCENARIOS = ["arterial_v1_5_storage_activation", "arterial_spillback_stress", "arterial_downstream_blockage"]
TRAINING_SEEDS = [20260921 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r14 training seeds overlap excluded seeds: {overlap}")
    ...
    core = {
        ...
        "controller_params": DYNAMIC_V1_5_R14_ROUTE_DEMAND_DOUBLE_SAFE_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "route-demand actions that lose finite-storage-double score are vetoed",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r13_route_demand",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r13_training_selection.json",
    }
    return {
        "experiment": "v1_5_r14_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r14_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r14_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r14_training_selection.json",
        },

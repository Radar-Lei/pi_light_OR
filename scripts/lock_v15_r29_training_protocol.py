#!/usr/bin/env python3
"""Lock a post-r28 v1.5-r29 core-baseline-envelope training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R29_CORE_BASELINE_ENVELOPE_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r29_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r29_core_baseline_envelope"
REQUIREMENTS_COVERED = ["V15-R29-CTRL-01", "V15-CLAIM-01"]
TRAINING_SCENARIOS = ["arterial_v1_5_storage_activation", "arterial_spillback_stress", "arterial_downstream_blockage"]
TRAINING_SEEDS = [20261071 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r29 training seeds overlap excluded seeds: {overlap}")
    ...
    core = {
        ...
        "controller_params": DYNAMIC_V1_5_R29_CORE_BASELINE_ENVELOPE_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "all-core completion envelope preserves unfinished-vehicle safety without collapsing action separation",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r28_max_pressure_envelope",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r28_training_selection.json",
    }
    return {
        "experiment": "v1_5_r29_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r29_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r29_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r29_training_selection.json",
        },

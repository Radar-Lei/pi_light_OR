#!/usr/bin/env python3
"""Lock a post-r98 v1.5 reactivated-dual unique-finishable-power-time-weight-horizon training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R100_REACTIVATED_DUAL_UNIQUE_FINISHABLE_POWER_TIME_WEIGHT_HORIZON_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r100_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r100_reactivated_dual_unique_finishable_power_time_weight_horizon"
REQUIREMENTS_COVERED = ["V15-R100-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261547 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r100 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R100_REACTIVATED_DUAL_UNIQUE_FINISHABLE_POWER_TIME_WEIGHT_HORIZON_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "route-horizon finishable credit has diminishing returns in volume and stronger time normalization",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r98_reactivated_dual_unique_finishable_power_horizon",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r98_training_selection.json",
    }
    return {
        "experiment": "v1_5_r100_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r100_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r100_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r100_training_selection.json",
        },

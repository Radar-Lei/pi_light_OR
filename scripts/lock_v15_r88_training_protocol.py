#!/usr/bin/env python3
"""Lock a post-r87 v1.5 reactivated-dual low-signal bonus-scale training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R88_REACTIVATED_DUAL_LOW_SIGNAL_BONUS_SCALE_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r88_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r88_reactivated_dual_low_signal_bonus_scale"
REQUIREMENTS_COVERED = ["V15-R88-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261475 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r88 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R88_REACTIVATED_DUAL_LOW_SIGNAL_BONUS_SCALE_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "early-severe low-signal completion bonuses are only lightly trimmed, preserving strong separation while removing weak bonus-only wins",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r87_reactivated_dual_low_signal_bonus_gate",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r87_training_selection.json",
    }
    return {
        "experiment": "v1_5_r88_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r88_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r88_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r88_training_selection.json",
        },

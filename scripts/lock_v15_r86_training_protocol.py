#!/usr/bin/env python3
"""Lock a post-r79 v1.5 reactivated-dual horizon zero-slack-floor training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R86_REACTIVATED_DUAL_HORIZON_ZERO_SLACK_FLOOR_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r86_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r86_reactivated_dual_horizon_zero_slack_floor"
REQUIREMENTS_COVERED = ["V15-R86-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261463 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r86 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R86_REACTIVATED_DUAL_HORIZON_ZERO_SLACK_FLOOR_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "raw route-horizon completion score removes artificial slack-floor credit only for nonpositive local-pressure movements",
    ...
    return {
        "experiment": "v1_5_r86_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r86_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r86_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r86_training_selection.json",
        },

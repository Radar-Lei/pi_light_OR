#!/usr/bin/env python3
"""Lock a post-r108 v1.5 reactivated-dual no-positive-pressure movement-finishable-power-horizon training protocol."""
...
DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r111_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r111_reactivated_dual_no_positive_pressure_movement_finishable_power_horizon"
REQUIREMENTS_COVERED = ["V15-R111-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261613 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r111 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R111_REACTIVATED_DUAL_NO_POSITIVE_PRESSURE_MOVEMENT_FINISHABLE_POWER_HORIZON_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "route-horizon no-positive-local-pressure phases with materially pressured downstream routes apply stronger concavity only to multi-vehicle finishable movements",
        ...
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r108_reactivated_dual_low_support_core_anchor",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r108_training_selection.json",
    }
    return {
        "experiment": "v1_5_r111_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r111_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r111_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r111_training_selection.json",
        },

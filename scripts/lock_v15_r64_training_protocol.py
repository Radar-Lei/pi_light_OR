#!/usr/bin/env python3
"""Lock a post-r63 v1.5 reactivated-dual-native-base-late-severe-safe training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R64_REACTIVATED_DUAL_NATIVE_BASE_LATE_SEVERE_SAFE_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r64_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r64_reactivated_dual_native_base_late_severe_safe"
REQUIREMENTS_COVERED = ["V15-R64-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261325 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r64 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R64_REACTIVATED_DUAL_NATIVE_BASE_LATE_SEVERE_SAFE_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "native finite-storage base plus dynamic dual terms separate earlier, while raw-consensus fallback is delayed until later, more severe occupancy",
    ...
    return {
        "experiment": "v1_5_r64_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r64_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r64_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r64_training_selection.json",
        },

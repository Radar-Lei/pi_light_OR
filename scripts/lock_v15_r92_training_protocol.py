#!/usr/bin/env python3
"""Lock a post-r90 v1.5 reactivated-dual supported score-gap-cap training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R92_REACTIVATED_DUAL_SUPPORTED_SCORE_GAP_CAP_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r92_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r92_reactivated_dual_supported_score_gap_cap"
REQUIREMENTS_COVERED = ["V15-R92-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261499 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r92 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R92_REACTIVATED_DUAL_SUPPORTED_SCORE_GAP_CAP_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "only supported thin-margin wins with large raw route-horizon score gaps are capped",
    ...
    return {
        "experiment": "v1_5_r92_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r92_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r92_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r92_training_selection.json",
        },

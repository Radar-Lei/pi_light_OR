#!/usr/bin/env python3
"""Lock a post-r92 v1.5 reactivated-dual unique-movement-horizon training protocol."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R96_REACTIVATED_DUAL_UNIQUE_MOVEMENT_HORIZON_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r96_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r96_reactivated_dual_unique_movement_horizon"
REQUIREMENTS_COVERED = ["V15-R96-CTRL-01", "V15-CLAIM-01"]
TRAINING_SEEDS = [20261523 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r96 training seeds overlap excluded seeds: {overlap}")
    ...
    core: dict[str, Any] = {
        ...
        "controller_params": DYNAMIC_V1_5_R96_REACTIVATED_DUAL_UNIQUE_MOVEMENT_HORIZON_PARAMS,
    ...
    return {
        "experiment": "v1_5_r96_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r96_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r96_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r96_training_selection.json",
        },

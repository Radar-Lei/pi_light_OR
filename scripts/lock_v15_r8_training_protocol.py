#!/usr/bin/env python3
"""Lock a post-r7 v1.5-r8 multi-baseline-filter training protocol with fresh seeds."""
...
from run_closed_loop_sumo import DYNAMIC_V1_5_R8_MULTI_BASELINE_FILTER_PARAMS

DEFAULT_OUT = "experiments/dual_sensitivity/v1_5_r8_training_protocol.json"
CONTROLLER_ID = "finite_storage_dynamic_primal_dual_v1_5_r8_multi_baseline_filter"
REQUIREMENTS_COVERED = ["V15-R8-TRAIN-01", "V15-CLAIM-01"]
TRAINING_SCENARIOS = [
    "arterial_v1_5_storage_activation",
    "arterial_spillback_stress",
    "arterial_downstream_blockage",
]
TRAINING_SEEDS = [20260861 + idx for idx in range(6)]
...
def build_training_protocol() -> dict[str, Any]:
    ...
    if overlap:
        raise ValueError(f"r8 training seeds overlap excluded seeds: {overlap}")
    ...
    core = {
        ...
        "controller_params": DYNAMIC_V1_5_R8_MULTI_BASELINE_FILTER_PARAMS,
        ...
        "selection_rule": {
            ...
            "eligible_for_selection_only_if": [
                ...
                "dynamic action must pass capacity-aware and finite-storage-double action filters",
                "action separation from pressure remains nonzero on binding training rows",
            ],
            "not_confirmatory_evidence": True,
        },
        "supersedes_candidate": "finite_storage_dynamic_primal_dual_v1_5_r7_double_filter",
        "supersession_trigger": "experiments/dual_sensitivity/v1_5_r7_training_selection.json",
    }
    payload: dict[str, Any] = {
        "experiment": "v1_5_r8_training_protocol",
        "status": "TRAINING_LOCKED",
        "generated_by": "scripts/lock_v15_r8_training_protocol.py",
        "requirements_covered": REQUIREMENTS_COVERED,
        **core,
        "protocol_fingerprint": base.stable_fingerprint(core),
        "artifact_plan": {
            "training_protocol": DEFAULT_OUT,
            "training_execution": "experiments/dual_sensitivity/v1_5_r8_training_execution.json",
            "training_selection": "experiments/dual_sensitivity/v1_5_r8_training_selection.json",
            "future_confirmatory_protocol": "experiments/dual_sensitivity/v1_5_r8_locked_protocol.json",
        },
        "claim_scope": {
            "claim_ready": False,

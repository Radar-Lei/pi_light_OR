...
from lock_v15_r5_training_protocol import CONTROLLER_ID, build_training_protocol  # noqa: E402
...
def test_r5_double_safe_controller_is_registered() -> None:
...
def test_r5_training_protocol_uses_fresh_seeds_and_is_not_claim_ready() -> None:
...
def test_r5_falls_back_to_finite_storage_double_when_dynamic_action_has_lower_pressure_support() -> None:
    ...
    assert audit["double_safety_fallback_used"] is True

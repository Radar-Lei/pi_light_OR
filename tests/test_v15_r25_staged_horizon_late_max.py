...
from lock_v15_r25_training_protocol import CONTROLLER_ID, build_training_protocol  # noqa: E402
...
def test_r25_staged_horizon_late_max_controller_is_registered() -> None:
...
def test_r25_late_terminal_lock_uses_max_pressure() -> None:
    ...
    assert late["selected_action"] == late["pressure_action"]
    assert late["route_horizon_completion_filter_used"] is False

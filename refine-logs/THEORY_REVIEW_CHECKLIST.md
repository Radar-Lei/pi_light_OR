...
- Gate A — Continuous relaxation and dual validity: **DRAFTED / SCRIPT-CHECKED** through `THRY-01`, `THRY-02`, and `scripts/run_dual_sanity.py`.
- Gate B — Pressure special case and scarcity correction: **DRAFTED / CLAIM-BOUNDED** through `THRY-03`, `THRY-04`, and Phase 3 routing language.
- Gate C — Finite-dictionary recovery quality: **DRAFTED / SCAFFOLD-CHECKED** through `THRY-05` and `scripts/run_sparse_recovery.py`.
